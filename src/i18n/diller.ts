...
const S: Record<string, Satir> = {
  ...
  // Sinematik koku sahnesi (KokuHero) — nav etiketleri + 4 slayt
  "koku.nav1": ["Koku", "Scent", "Duft", "Parfum", "Aroma", "Profumo", "Аромат", "عطر", "Aroma", "香气"],
  "koku.nav2": ["Amber", "Amber", "Amber", "Ambre", "Ámbar", "Ambra", "Амбра", "عنبر", "Âmbar", "琥珀"],
  "koku.nav3": ["Likit", "Liquid", "Flüssig", "Liquide", "Líquido", "Liquido", "Жидкость", "سائل", "Líquido", "液态"],
  "koku.nav4": ["Dijital", "Digital", "Digital", "Numérique", "Digital", "Digitale", "Цифра", "رقمي", "Digital", "数字"],

  "koku.slide1Satir1": ["Koku", "Scent", "Duft", "Le Parfum", "Aroma", "Profumo", "Аромат", "العطر", "Aroma", "香气"],
  "koku.slide1Satir2": ["ve Zaman", "and Time", "und Zeit", "et le Temps", "y Tiempo", "e Tempo", "и Время", "والزمن", "e Tempo", "与时间"],
  "koku.slide1Col1": [
    "Zamansız bir malzeme, yüzyıllar boyu insan hafızasını taşır. Alevde uçucu, izinde ebedi. Her nota, geçici ama yoğun bir anı yakalar.",
    "A timeless material carrying centuries of human memory. Fleeting in flame, eternal in trace. Every note captures a brief, intense moment.",
    "Ein zeitloses Material, das jahrhundertealte menschliche Erinnerung trägt. Flüchtig in der Flamme, ewig in der Spur. Jede Note hält einen kurzen, intensiven Moment fest.",
    "Une matière intemporelle qui porte la mémoire humaine à travers les siècles. Fugace dans la flamme, éternelle dans son sillage. Chaque note capture un instant bref et intense.",
    "Una materia atemporal que lleva siglos de memoria humana. Fugaz en la llama, eterna en su estela. Cada nota captura un instante breve e intenso.",
    "Una materia senza tempo che porta secoli di memoria umana. Fugace nella fiamma, eterna nella scia. Ogni nota cattura un istante breve e intenso.",
    "Материя вне времени, несущая память веков. Мимолётная в пламени, вечная в шлейфе. Каждая нота — краткий, но яркий миг.",
    "مادة خالدة تحمل ذاكرة الإنسان عبر القرون. عابرة في اللهب، خالدة في الأثر. كل نوتة تلتقط لحظة قصيرة لكنها مكثفة.",
    "Uma matéria atemporal que carrega séculos de memória humana. Fugaz na chama, eterna em seu rastro. Cada nota captura um instante breve e intenso.",
    "跨越世纪、承载人类记忆的永恒之物。在火焰中转瞬即逝，在余香中恒久留存。每一个香调，都定格一个短暂却浓烈的瞬间。",
  ],
  "koku.slide1Col2": [
    "Ham maddenin ateşinden doğan koku, hafızamızla hayalimiz arasında köprü kurar. Akışkan bir enerji, cam bir şişede dondurulmuş.",
    "Born of raw material's fire, scent bridges memory and imagination. A fluid energy, frozen still inside glass.",
    "Aus dem Feuer des Rohstoffs geboren, schlägt der Duft eine Brücke zwischen Erinnerung und Vorstellung. Eine fließende Energie, erstarrt im Glas.",
    "Née du feu de la matière brute, la senteur relie mémoire et imaginaire. Une énergie fluide, figée dans le verre.",
    "Nacido del fuego de la materia prima, el aroma une memoria e imaginación. Una energía fluida, congelada en el cristal.",
    "Nato dal fuoco della materia prima, il profumo unisce memoria e immaginazione. Un'energia fluida, congelata nel vetro.",
    "Рождённый в огне сырья, аромат соединяет память и воображение. Текучая энергия, застывшая в стекле.",
    "وُلد من نار المادة الخام، يربط العطر بين الذاكرة والخيال. طاقة سائلة، مجمّدة داخل الزجاج.",
    "Nascido do fogo da matéria-prima, o aroma une memória e imaginação. Uma energia fluida, congelada no vidro.",
    "诞于原料之火的香气，在记忆与想象之间架起桥梁。一股流动的能量，凝结于玻璃之中。",
  ],

  "koku.slide2Baslik": ["Amber Duygusu", "Amber Emotion", "Amber-Gefühl", "Émotion d'Ambre", "Emoción de Ámbar", "Emozione d'Ambra", "Эмоция Амбры", "شعور العنبر", "Emoção de Âmbar", "琥珀之情"],
  "koku.slide2Desc": [
    "İnsan duygusunun en yoğun anında donmuş bir kompozisyon. Karakterin, zevkin ve anın izini süren; kaderin bağladığı notalarla örülü bir imza.",
    "A composition frozen at the peak of human emotion. Tracing character, taste and moment — a signature woven from notes bound by fate.",
    "Eine Komposition, erstarrt im intensivsten Moment menschlicher Emotion. Sie spürt Charakter, Geschmack und Augenblick auf — eine Signatur aus schicksalhaft verbundenen Noten.",
    "Une composition figée au sommet de l'émotion humaine. Elle suit le caractère, le goût et l'instant — une signature tissée de notes liées par le destin.",
    "Una composición congelada en el punto álgido de la emoción humana. Sigue el carácter, el gusto y el instante — una firma tejida con notas unidas por el destino.",
    "Una composizione congelata nel picco dell'emozione umana. Segue carattere, gusto e istante — una firma intrecciata di note legate dal destino.",
    "Композиция, застывшая на пике человеческого чувства. Она улавливает характер, вкус и миг — подпись, сотканная из нот, связанных судьбой.",
    "تركيبة تجمّدت في ذروة المشاعر الإنسانية. تتتبع الشخصية والذوق واللحظة — توقيع منسوج من نوتات جمعها القدر.",
    "Uma composição congelada no auge da emoção humana. Segue caráter, gosto e instante — uma assinatura tecida de notas unidas pelo destino.",
    "定格于人类情感巅峰的一支组合香。追寻性格、品味与瞬间——由命运牵系的香调编织而成的签名香气。",
  ],

  "koku.slide3Baslik": ["Likit Altın", "Liquid Gold", "Flüssiges Gold", "Or Liquide", "Oro Líquido", "Oro Liquido", "Жидкое Золото", "الذهب السائل", "Ouro Líquido", "液态黄金"],
  "koku.slide3Desc": [
    "Nefes alan bir sanat. Likit altın dalgaları mekânda akar, ustaca damıtılmış her notanın gerilimini ve dokusunu yansıtır.",
    "Art that breathes. Waves of liquid gold flow through space, reflecting the tension and texture of every masterfully distilled note.",
    "Kunst, die atmet. Wellen aus flüssigem Gold fließen durch den Raum und spiegeln die Spannung und Textur jeder meisterhaft destillierten Note.",
    "Un art qui respire. Des vagues d'or liquide traversent l'espace, reflétant la tension et la texture de chaque note distillée avec maîtrise.",
    "Un arte que respira. Olas de oro líquido fluyen por el espacio, reflejando la tensión y textura de cada nota destilada con maestría.",
    "Un'arte che respira. Onde d'oro liquido scorrono nello spazio, riflettendo la tensione e la texture di ogni nota distillata magistralmente.",
    "Искусство, которое дышит. Волны жидкого золота текут в пространстве, отражая напряжение и текстуру каждой мастерски дистиллированной ноты.",
    "فن يتنفّس. تتدفق موجات الذهب السائل عبر الفضاء، تعكس توتر وملمس كل نوتة قُطرت بمهارة.",
    "Uma arte que respira. Ondas de ouro líquido fluem pelo espaço, refletindo a tensão e a textura de cada nota destilada com maestria.",
    "会呼吸的艺术。液态黄金的波纹在空间中流淌，映照出每一个精心蒸馏的香调所蕴含的张力与质感。",
  ],

  "koku.slide4Satir1": ["Ebedi", "Eternal", "Ewiger", "Instant", "Instante", "Istante", "Вечное", "اللحظة", "Instante", "永恒"],
  "koku.slide4Satir2": ["An", "Moment", "Moment", "Éternel", "Eterno", "Eterno", "мгновение", "الخالدة", "Eterno", "瞬间"],
  "koku.slide4Desc": [
    "Klasik parfümeriyi yeni boyutların merceğinden düşünmek. Zamansız bir zanaat, algoritmanın ışıltılı akışında yeniden doğuyor.",
    "Contemplating classic perfumery through the lens of new dimensions. A timeless craft, reborn in the radiant flow of the algorithm.",
    "Klassische Parfümerie durch die Linse neuer Dimensionen betrachtet. Ein zeitloses Handwerk, wiedergeboren im strahlenden Fluss des Algorithmus.",
    "Contempler la parfumerie classique à travers le prisme de nouvelles dimensions. Un artisanat intemporel, renaissant dans le flux radieux de l'algorithme.",
    "Contemplar la perfumería clásica a través del prisma de nuevas dimensiones. Un oficio atemporal, renacido en el flujo radiante del algoritmo.",
    "Contemplare la profumeria classica attraverso la lente di nuove dimensioni. Un mestiere senza tempo, rinato nel flusso radioso dell'algoritmo.",
    "Созерцание классической парфюмерии сквозь призму новых измерений. Вневременное ремесло, возрождённое в сияющем потоке алгоритма.",
    "التأمل في فن العطور الكلاسيكي من منظور أبعاد جديدة. حرفة خالدة، تُبعث من جديد في تدفق الخوارزمية المتلألئ.",
    "Contemplar a perfumaria clássica através da lente de novas dimensões. Um ofício atemporal, renascido no fluxo radiante do algoritmo.",
    "透过新维度的视角，重新审视经典调香工艺。这门永恒的技艺，在算法的璀璨流动中获得新生。",
  ],
  "karsilama.alt": [
